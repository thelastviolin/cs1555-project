...
public class Team10 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Team10 auctionHouse = new Team10();
	...
	public void bidOnAuction(String login) {
		...
		while(numberOfTries < 3){
			try {
				...
				numberOfTries++;
				System.out.println("There was an error inserting your new bid. Your bid of " + bidAmount + " on auction id " + auction_id + " is too low");
				try{
					connection.rollback();
				}catch (SQLException ex){
					System.out.println("Cannot rollback: " + ex);
				}
